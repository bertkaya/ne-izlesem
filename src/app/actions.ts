...
export async function askGemini(prompt: string) {
  ...
  try {
    ...
    const systemInstruction = `You are a movie expert. Analyze: "${prompt}". SCENARIO 1: Specific list -> { "recommendations": [{ "title": "Movie", "type": "movie" }, ...] } SCENARIO 2: Genre/Mood -> { "params": { "genre_ids": "...", "sort_by": "...", "year_range": "...", "type": "..." } } Return ONLY valid JSON.`;
